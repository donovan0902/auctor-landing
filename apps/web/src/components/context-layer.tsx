...
const outputs: OutputItem[] = [
  ...
  },
  {
    icon: ScrollText,
    label: "Requirements",
    lines: ["Structured requirements", "Decision traceability", "Open risks + gaps"],
  },
  {
    icon: FileText,
    label: "User Stories",
  ...
  },
  {
    icon: ListChecks,
    label: "Test Scripts",
    lines: ["Validation scenarios", "Coverage by requirement", "Go-live checks"],
  },
]
...
function SourceChip({
  ...
  return (
    ...
    >
      <Card
        className={`h-full rounded-[0.95rem] border bg-background ring-0 shadow-[0_14px_30px_-24px_rgba(15,23,42,0.34)] ${
          live
            ? "border-amber-700/28"
            : "border-border"
        }`}
        ...
        <div className="flex h-full items-center px-3.5 py-2">
          <div className="flex w-full min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0 self-center">
              <CardTitle
                className="text-[11px] font-semibold leading-[1.15] tracking-[-0.01em] text-balance"
                style={{
                  display: "-webkit-box",
                  WebkitLineClamp: 2,
                  ...
                  <div className="flex items-start gap-2.5">
                    <div className="flex min-w-0 items-center gap-2.5">
                      ...
                      <div className="flex min-w-0 items-center gap-2">
                        <CardTitle className="text-[14px] font-semibold leading-none">
                          {item.label}
                        </CardTitle>
                        <motion.div
                  ...
                  <div className="flex min-h-0 flex-1 flex-col gap-2 overflow-y-auto pr-1">
                    {item.lines.map((line, lineIndex) => (
                      ...
                      <motion.div
                        ...
                        transition={{
                          duration: shouldPulse ? syncPulseDuration : 0.2,
                          ease: "easeInOut",
                        }}
                      >
...
export function ContextLayer({ embedded = false }: { embedded?: boolean }) {
  ...
  const liveTargets = useMemo(
    () =>
      liveSourceSlots.map((slot) => pointOnCircle(cx, cy, ringRadius + 2, slot.angle)),
    [cx, cy, ringRadius]
  )
    ...
    const docIndexes = Array.from(
      new Set(
        activeLiveNotifications.flatMap((notification) => {
          const entry =
            liveSourceSlots[notification.slotIndex].entries[notification.entryIndex]
  ...
  return (
    <section className={embedded ? "px-0 pt-8 pb-0 lg:pt-12" : "px-4 py-20 lg:px-6 lg:py-24"}>
      <div className={embedded ? "mx-auto max-w-[84rem]" : "mx-auto max-w-[84rem]"}>
        {embedded ? null : (
          <div className="mx-auto mb-14 max-w-3xl text-center lg:mb-16">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
              ...
              into Auctor. It turns that context into structured requirements and
              keeps delivery artifacts aligned as scope evolves.
            </p>
          </div>
        )}
          ...
          <svg viewBox="0 0 1200 760" className="h-auto w-full" fill="none">
            <defs>
              <radialGradient id="ringGlow" cx="50%" cy="50%" r="50%">
                ...
                <stop offset="66%" stopColor="oklch(0.8 0.018 70)" stopOpacity={0.12} />
              ...
              <linearGradient id="sourceFlow" x1="0%" y1="0%" x2="100%" y2="0%">
                <stop offset="0%" stopColor="oklch(0.76 0.015 72)" stopOpacity={0.2} />
                <stop offset="100%" stopColor="oklch(0.6 0.028 50)" stopOpacity={0.62} />
              </linearGradient>
            </defs>
            ...
            />
            <foreignObject x={cx - 252} y={cy - ringRadius - 36} width={504} height={72}>
